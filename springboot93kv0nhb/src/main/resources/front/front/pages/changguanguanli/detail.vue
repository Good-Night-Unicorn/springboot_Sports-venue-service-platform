		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			...
			<view :style='{"width":"100%","padding":"24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">管理姓名：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.guanlixingming}}</view>
				</view>
				<view :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">性别：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.xingbie}}</view>
				</view>
	...
	export default {
		...
		async onShow(options) {
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('changguanguanli', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','changguanguanli');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','changguanguanli');
			...
			async init(type=1){
				...
				let res = await this.$api.info('changguanguanli', this.id);
				let reg=new RegExp('http://localhost:8080/springboot93kv0nhb/upload','g')//g代表全部
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('changguanguanli',this.detail)
				}
			},

		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			<view :style='{"width":"100%","padding":"24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>关联表id：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.refid}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>置顶(1:置顶,0:非置顶)：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.istop}}</view>
				</view>



				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>评论内容：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.content}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>回复内容：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.reply}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>赞用户ids：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.tuserids}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>踩用户ids：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.cuserids}}</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"10rpx 0","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"2rpx solid #7C6047","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#7C6047","borderRadius":"8rpx","background":"none","width":"auto","fontSize":"26rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="userid&&isAuth('discussyundongchangguan','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"2rpx solid #7C6047","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#7C6047","borderRadius":"8rpx","background":"none","width":"auto","fontSize":"26rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="!userid&&isAuthFront('discussyundongchangguan','私聊')" @tap="chatClick">联系TA</button>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscussyundongchangguanCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscussyundongchangguanCleanType')
				this.mescroll.num = 1
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('discussyundongchangguan', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','discussyundongchangguan');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','discussyundongchangguan');
			...
			async init(type=1){
				...
				let res = await this.$api.info('discussyundongchangguan', this.id);
				let reg=new RegExp('http://localhost:8080/springboot93kv0nhb/upload','g')//g代表全部
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('discussyundongchangguan',this.detail)
				}
			},
			...
			async upCallback(mescroll) {
				if(uni.getStorageSync("appUserid")){
					let res = await this.$api.list('discussdiscussyundongchangguan', {
						page: mescroll.num,
						limit: 10,
			...
			async comzanClick(row){
				...
				if(!this.comzanChange(row)){
					...
					await this.$api.update('discussdiscussyundongchangguan',row)
					this.$utils.msg('点赞成功');
				}else {
					row.thumbsupnum--
					let arr = String(row.tuserids).split(',')
			...
			async onCommentTap() {
				...
				let res = {}
				this.$utils.jump(`../discussdiscussyundongchangguan/add-or-update?refid=${this.id}` )
			},
			delClick(id){
				let that = this
				uni.showModal({
					...
					async success(res) {
						if(res.confirm){
							await that.$api.del('discussdiscussyundongchangguan',JSON.stringify([id]))
							that.$utils.msg('删除成功')
							that.detail.discussnum--
							await that.$api.update('discussyundongchangguan',that.detail)
							setTimeout(()=>{

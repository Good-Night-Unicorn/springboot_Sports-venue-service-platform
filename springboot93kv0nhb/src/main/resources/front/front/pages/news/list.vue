		...
		<view class="content">
			<view :style='{"padding":"0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"100%"}'>
				...
				<view :style='{"width":"100%","padding":"10rpx","margin":"0","flexWrap":"wrap","background":"#F6F6F6","display":"flex"}'>
					<view @click="sortClick('clicknum')" :style='{"border":"2rpx solid #7C6047","padding":"0 12rpx","margin":"0 8rpx 0 0","outline":"0","borderRadius":"0","background":"#FFFBF7","display":"flex"}'>
						<text :style='{"color":"#7C6047","lineHeight":"40rpx","fontSize":"24rpx"}'>点击量</text>
						<text v-if="listSort!='clicknum'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#7C6047"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='asc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#7C6047"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='desc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#7C6047"}'></text>
					</view>
				...
				<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
					...
					<view class="news-box3" :style='{"width":"100%","padding":"20rpx 0","margin":"0","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"8rpx 40rpx","margin":"0","borderColor":"#7C6047","backgroundColor":"rgba(255,255,255,1)","display":"flex","justifyContent":"space-between","borderRadius":"0","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}'>
							...
							<view :style='{"padding":"0 20rpx","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
							...
							<view :style='{"padding":"0 20rpx","order":"4"}'>
								...
								<text :style='{"color":"#7C6C33","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.name}}</text>
							</view>
							<view :style='{"padding":"0 20rpx","display":"inline-block","order":"1"}'>
								...
								<text :style='{"color":"#7C6047","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.thumbsupnum}}</text>
							</view>
							...
							<view :style='{"padding":"0 20rpx","display":"inline-block","order":"3"}'>
								...
								<text :style='{"color":"#EBD9AF","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.clicknum}}</text>
							</view>
							<view class="cuIcon-right" :style='{"display":"none"}'></view>
						</view>
					</view>
				...
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","color":"rgb(255, 255, 255)","bottom":"40rpx","right":"8rpx","outline":"none","borderRadius":"100%","background":"#7C6047","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('news','新增')" class="add-btn" @click="onAddTap()">新增</button>

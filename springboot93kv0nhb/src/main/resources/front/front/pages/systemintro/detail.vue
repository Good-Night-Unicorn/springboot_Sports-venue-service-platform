	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			...
			<view :style='{"width":"100%","padding":"24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"margin":"10rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>副标题：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"60rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.subtitle}}</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"10rpx 0","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"2rpx solid #7C6047","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#7C6047","borderRadius":"8rpx","background":"none","width":"auto","fontSize":"26rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="userid&&isAuth('systemintro','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"2rpx solid #7C6047","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#7C6047","borderRadius":"8rpx","background":"none","width":"auto","fontSize":"26rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="!userid&&isAuthFront('systemintro','私聊')" @tap="chatClick">联系TA</button>

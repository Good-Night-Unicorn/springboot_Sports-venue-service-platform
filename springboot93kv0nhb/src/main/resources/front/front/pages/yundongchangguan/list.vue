			...
			<view :style='{"padding":"0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"100%"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 0","alignItems":"center","background":"#fff","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' class="search-form round">
						...
						<input :style='{"border":"2rpx solid #7C6047","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"0","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.changguanmingcheng" type="text" placeholder="场馆名称" ></input>
					</view>
				...
				<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
					<scroll-view scroll-x="true" class="category-one" :style='{"width":"100%","padding":"0 10rpx 20rpx","whiteSpace":"nowrap","background":"#7C6047","display":"flex","height":"auto"}'>
						<view :class='categoryName === item.changguanleixing ? "active" : ""' class="tab" v-for="(item,index) in categoryList" :key="index" @tap="categoryClick(item.changguanleixing)">{{item.changguanleixing}}</view>
					</scroll-view>
						...
						<block v-for="(list,index) in lists" :key="index">
							<view v-if="list.length>0" @tap="onDetailTap(list[0])" class="list-item" :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[0]">
									...
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[0]">
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[0])">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[0].id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
							...
							<view v-if="list.length>1" class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0 0 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view v-if="list.length>1" @tap="onDetailTap(list[1])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[1]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[1]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[1])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[1].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view v-if="list.length>2" @tap="onDetailTap(list[2])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[2]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[2]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[2])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[2].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
							...
							<view v-if="list.length>3" @tap="onDetailTap(list[3])" class="list-item" :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<!-- #ifdef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[3]">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[3]">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[3])">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[3].id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
							...
							<view v-if="list.length>4" class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view v-if="list.length>4" @tap="onDetailTap(list[4])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[4]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[4]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[4])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[4].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view v-if="list.length>5" @tap="onDetailTap(list[5])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[5]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDelete" :data-row="list[5]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('yundongchangguan','修改')) || (!userid && isAuthFront('yundongchangguan','修改'))" @tap.stop.proevent="onUpdateTap(list[5])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('yundongchangguan','删除')) || (!userid && isAuthFront('yundongchangguan','删除'))" @tap.stop.proevent="onDeleteTap(list[5].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 20rpx 20rpx","fontSize":"22rpx","color":"#858585"}'>场馆位置</view>
						<input :style='{"border":"2rpx solid #ccc","width":"95%","padding":"0 20rpx 0 20rpx","borderRadius":"4rpx","background":"#fff","height":"60rpx"}' placeholder="请输入场馆位置" v-model="searchForm.changguanweizhi">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						<view :style='{"width":"100%","padding":"0 0 20rpx 20rpx","fontSize":"22rpx","color":"#858585"}'>时间段</view>
						<view :style='{"width":"100%","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
							<view @click="shijianduanChange(item)" v-for="(item,index) in shijianduanOptions" :key="index" class="screenTab" :class="searchForm.shijianduan==item?'screenTabActive':''">{{item}}</view>
						</view>
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						<view :style='{"width":"100%","padding":"0 0 20rpx 20rpx","fontSize":"22rpx","color":"#858585"}'>场馆状态</view>
						<view :style='{"width":"100%","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
							<view @click="changguanzhuangtaiChange(item)" v-for="(item,index) in changguanzhuangtaiOptions" :key="index" class="screenTab" :class="searchForm.changguanzhuangtai==item?'screenTabActive':''">{{item}}</view>
						</view>
					</view>
...
<script>
	export default {
		...
		methods: {
			shijianduanChange(e){
				this.searchForm.shijianduan = e
				this.$forceUpdate()
			},
			changguanzhuangtaiChange(e){
				this.searchForm.changguanzhuangtai = e
				this.$forceUpdate()
			},
			screenReset(){
				this.searchForm = {}
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.changguanzhuangtai){
					params['changguanzhuangtai'] = '%' + this.searchForm.changguanzhuangtai + '%'
				}
				let user = uni.getStorageSync("appUserid")?JSON.parse(uni.getStorageSync('userSession')):{}
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`yundongchangguan`, params);
                } else {
                    res = await this.$api.list(`yundongchangguan`, params);
                }
			...
			onDeleteTap(id){
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.del('yundongchangguan', JSON.stringify([id]));
			...
			async search(){
				...
				if(this.categoryName!='全部'){
					searchForm.changguanleixing = '%' + this.categoryName + '%'
				}
				if(this.searchForm.changguanweizhi){
				...
				if(this.searchForm.changguanzhuangtai){
					searchForm['changguanzhuangtai'] = this.searchForm.changguanzhuangtai
				}
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`yundongchangguan`, searchForm);
                } else {
                    res = await this.$api.list(`yundongchangguan`, searchForm);
                }
				// 如果是第一页数据置空

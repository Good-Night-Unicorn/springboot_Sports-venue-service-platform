			...
			<view :style='{"padding":"0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"100%"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 0","alignItems":"center","background":"#fff","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' class="search-form round">
						...
						<input :style='{"border":"2rpx solid #7C6047","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"0","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.name" type="text" placeholder="名称" ></input>
					</view>
						...
						<block v-for="(list,index) in lists" :key="index">
							<view v-if="list.length>0" @tap="onDetailTap(list[0])" class="list-item" :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[0]">
									...
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[0]">
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[0])">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[0].id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
							...
							<view v-if="list.length>1" class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0 0 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view v-if="list.length>1" @tap="onDetailTap(list[1])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[1]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[1]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[1])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[1].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view v-if="list.length>2" @tap="onDetailTap(list[2])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[2]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[2]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[2])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[2].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
							...
							<view v-if="list.length>3" @tap="onDetailTap(list[3])" class="list-item" :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<!-- #ifdef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[3]">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[3]">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[3])">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[3].id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
									</view>
								</view>
							...
							<view v-if="list.length>4" class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view v-if="list.length>4" @tap="onDetailTap(list[4])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[4]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[4]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[4])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[4].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view v-if="list.length>5" @tap="onDetailTap(list[5])" :style='{"padding":"0","margin":"0","borderColor":"#7C6047","borderWidth":"0 0 2rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
									...
									<!-- #ifdef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="list[5]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="list[5]">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"8rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
										<view :style='{"border":"2rpx solid #7C6047","width":"45%","justifyContent":"center","display":"flex","order":"1"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(list[5])">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#7C6047","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"border":"2rpx solid #C4BCA9","width":"45%","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(list[5].id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#C4BCA9","display":"inline-block"}'>删除</text>
										</view>
									</view>

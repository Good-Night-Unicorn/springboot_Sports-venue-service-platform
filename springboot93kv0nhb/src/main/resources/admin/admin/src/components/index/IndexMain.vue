<template>
	<div style="height: 100%;">
		<el-main :style='"horizontal" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 177px","margin":"0","position":"relative","background":"#f5f5f5","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(0, 0, 0, .3)","padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"center","background":"#fff","gap":"20px","width":"100%","fontSize":"16px","position":"inherit","zIndex":"999","height":"90px"}'></index-header>
			...
			<template v-if="'horizontal' == 'horizontal'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :style='{"borderColor":"#efefef","background":"#303030","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'></index-aside>
			  </template>
			</template>
			
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"14px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>

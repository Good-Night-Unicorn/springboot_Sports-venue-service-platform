<template>
	<div :style='{"padding":"30px"}'>
		<el-form
			...
			label-width="180px"
		>
			<el-form-item :style='{"border":"0px solid #eee","width":"32%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="原密码" prop="password">
				<el-input type="password" v-model="ruleForm.password" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"0px solid #eee","width":"32%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="新密码" prop="newpassword">
				<el-input type="password" v-model="ruleForm.newpassword" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"0px solid #eee","width":"32%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="确认密码" prop="repassword">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'changguanguanli') {
					}
					if (this.ruleForm.password != password) {
						this.$message.error("原密码错误");
						return;

	...
	<div class="addEdit-block">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="guanlizhanghao" >
					<el-input v-model="ruleForm.guanlizhanghao" placeholder="商户名称" clearable  :readonly="ro.guanlizhanghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="商户名称" prop="guanlizhanghao" >
					<el-input v-model="ruleForm.guanlizhanghao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
